...
const api = {
    ...
    updateProfile: async (payload) => api.request('/auth/me/', 'PUT', payload),
    uploadAvatar: async (file) => { const fd = new FormData(); fd.append('avatar', file); return api.request('/auth/me/', 'PUT', fd); },
